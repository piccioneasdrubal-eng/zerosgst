...
Nel menu di gioco inserisci l'URL pubblico del backend, ad esempio `wss://ws.zerothelegend.gamer.gd`, e premi **Salva server**. Il client lo converte automaticamente in `wss://...`.
...
`start-cloudflared.bat` pubblica la porta 3000. Per questa build il backend realtime usa Render: `wss://ws.zerothelegend.gamer.gd`.
