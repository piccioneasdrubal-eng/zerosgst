(() => {
  ...
  // Curated languages, in the order they should appear at the TOP of the
  // language picker (grouped under "Lingue principali"). These are the only
  // languages with a hand-written dictionary below; everything else in
  // LANGS/EXTRA is translated live via remoteTranslate() (Google Translate).
  const PRIMARY = ['it','en','es','fr','de','pt','ru','zh','ja','ko','ar','tr','scn'];
  ...
  // Only English gets the (English-language) base dictionary as its own
  // translation. Every other non-curated language is intentionally left
  // WITHOUT a dictionary here: translateKnown() then falls through to
  // remoteTranslate() (live Google Translate) so it shows real text in
  // that language instead of silently displaying English.
  add('en', base);
  ...
  // Sicilian (regional language of Italy, ISO 639-3 "scn"). Best-effort
  // dictionary for the main menu labels; anything not listed here falls
  // back to live translation like every other non-curated language.
  add('scn', {'Menu Utente':'Menu Utenti','Profilo':'Prufilu','Gioca':'Joca','Shop':'Buttiga','Statistiche':'Statistichi','Impostazioni':'Cunfigurazzioni','Controlli':'Cumanni','Grafica':'Grafica','Audio':'Audiu','Lingua':'Lingua','100 Funzioni':'100 Funzioni','Admin/Staff':'Admin/Staff','Gioca ora':'Joca ora','Riavvia partita':'Ricumincia partita','Spettatore':'Spettaturi','Schermo intero':'Sckermu ntreru','Controlla server':'Cuntrolla server','Modalità FFA':'Modalità FFA','Modalità Squadre':'Modalità Squatri','Wallet':'Purtafogliu','Catalogo':'Catalogu','Inventario':'Nvintariu','Storico':'Storicu','Missioni':'Missioni','Daily':'Giurnalieru','Ricompensa giornaliera':'Ricumpensa giurnaliera','Starter Gift':'Rigalu di partenza','x2 Coins':'x2 Munita','Classifica':'Classifica','Classifica stagione':'Classifica dâ staggiuni','Carica skin':'Carrica skin','Le mie skin':'I me skin','Usa skin':'Usa a skin','In uso':'ĂN usu','Usa default':'Usa chidda di default','Nome skin':'Nomu dâ skin','Formato':'Furmatu','Dimensione':'Rannizza','Scegli la lingua del gioco':'Scegghi a lingua dû jocu','Traduzione completa interfaccia':'Traduzzioni comprita dâ nterfaccia','Seleziona lingua':'Scegghi a lingua','Tutti contro tutti':'Tutti contra tutti','Squadre bilanciate':'Squatri bilanciati','Mostra nomi':'Fai vidiri i nomi','Mostra massa':'Fai vidiri a massa','Mostra minimappa':'Fai vidiri a minimappa','Mostra HUD':'Fai vidiri lu HUD','Mostra griglia':'Fai vidiri a grigghia','Grafica 3D':'Grafica 3D','Grafica leggera':'Grafica leggera','Camera fluida':'Camera fluita','Riconnessione automatica':'Riconnessioni automatica','Effetti sonori':'Effetti sonori','Zoom rotellina':'Zoom cu â rutedda','Effetti visivi':'Effetti visivi','Ombre cellule':'Ummiri dî celluli','Glow cellule':'Luci dî celluli','Mostra pellet':'Fai vidiri i pallini','Mostra power-up':'Fai vidiri i putenziamenti','Mostra zone':'Fai vidiri i zoni','Bordo arena':'Bordu dâ arena','Colori squadra':'Culuri dâ squatra','Contorno nemici':'Cuntornu nnimici','Contorno alleati':'Cuntornu alleati','Marker centrale':'Signu centrali','Crosshair':'Miritinu','Linea mira':'Linia dâ mira','Auto respawn':'Auto respawn','Riavvio rapido':'Ricuminciu rapitu','Protezione spawn':'Prutizzioni dû spawn','Spettatore automatico':'Spettaturi automaticu','Filtro chat':'Filtru dâ chat','Qualità dinamica':'Qualità dinamica','Statistiche rete':'Statistichi dâ riti','Ping':'Ping','FPS':'FPS','Coordinate':'Cuurdinati','Avvisi zona':'Avvisi dâ zona','Auto Save':'Sarvamentu automaticu','Ricorda scheda':'Ricorda a scheda','Suggerimenti tastiera':'Cunsigghi dâ tastera','Pausa nel menu':'Pausa nnô menu','Fullscreen all’avvio':'Sckermu ntreru all’avviu','Controlli touch':'Cumanni touch','Sfondo arena':'Sfunnu dâ arena','Vignetta':'Vignetta','Movimento ridotto':'Muvimentu ridduttu','Contrasto alto':'Cuntrastu autu','Modalità daltonismo':'Modalità daltonismu','Sfocatura menu':'Sfucatura dû menu','HUD compatto':'HUD cumpattu','Conferma acquisti':'Cunferma i cumpri','Conferma azioni':'Cunferma azzioni','Musica':'Musica','Muto globale':'Mutu globali','Accessibilità':'Accessibbilità','Progressi livello':'Prugressi dû livellu','Partite':'Partiti','Max massa':'Massa massima','Miglior rank':'Megghiu classifica','Kill':'Ammazzati','Morti':'Morti','Coins':'Munita','Livello':'Livellu','XP':'XP','Progressi':'Prugressi','Tempo di gioco':'Tempu di jocu','Stato account':'Statu dû cuntu','Account':'Cuntu','Ruolo':'Ruolu','ID account':'ID dû cuntu','Data registrazione':'Data dâ registrazzioni','ZeroShop':'ZeroShop','Acquista':'Accatta','Acquisto':'Accattu','Inizia':'Accumincia','Chiudi':'Chiuri','Salva':'Sarva','Ripristina':'Ripristina','Profilo utente':'Prufilu dû utenti','Impostazioni di gioco':'Cunfigurazzioni dû jocu','Tasto Split':'Tastu Split','Tasto Feed':'Tastu Feed','Tasto Virus':'Tastu Virus','Effetti speciali':'Effetti spiciali','God Mode':'God Mode','10 secondi':'10 secunni','Server':'Server','Connesso':'Cunnittutu','Disconnesso':'Discunnittutu','Nessuno':'Nuddu','Default':'Default','Skin':'Skin','Crea Account':'Crea cuntu','Accedi':'Trasi','Registrati':'Arregistrati','Esci':'Nesci','Nessun utente autenticato':'Nuddu utenti autenticatu','Benvenuto':'Bonvinutu','Mouse = muoviti':'Mouse = movìti','Spazio = split':'Spazziu = split','W = feed':'W = feed','Q = virus':'Q = virus','ESC = Menu Utente':'ESC = Menu Utenti'});
  ...
  function populate(select){
    ...
    const restCodes=allCodes.filter(c=>!PRIMARY.includes(c));
    const optionHtml=code=>'<option value="'+esc(code)+'">'+getFlag(code)+' '+esc(langName(code))+'</option>';
    select.innerHTML='<option value="" disabled>'+getFlag(current)+' '+esc(langName(current))+'</option>'
      +'<optgroup label="⭐ Lingue principali">'+PRIMARY.map(optionHtml).join('')+'</optgroup>'
      +'<optgroup label="🌐 Altre lingue">'+restCodes.map(optionHtml).join('')+'</optgroup>';
